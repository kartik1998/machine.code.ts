...
class CodingBlox {
    ...
    static createContest(contestName, contestLevel, contestCreatorName) {
        ...
        if (!contestCreator)
            throw new Error(`User ${contestCreatorName} does not exist. Cannot create contest`);
    ...
    static attendContest(contestId, userName) {
        ...
        if (!contest)
            throw new Error(`Contest ${contestId} does not exist`);
    ...
    static runContest(contestId, contestCreatorName) {
        ...
        if (!user)
            throw new Error(`Contest creator user: ${contestCreatorName} does not exist`);
        ...
        if (contestState === 'FINISHED')
            throw new Error(`Contest is already completed`);
